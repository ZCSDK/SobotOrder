...
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_CHAT; // 对话
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_ORDER; // 工单
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_SETTING;// 设置
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_MONITORINGSTATISTICS;// 监控统计

extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_CALL;  // 呼叫模块
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_USERS; // 用户模块
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_STATISTICS_ONLINE;// 统计在线
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_STATISTICS_CALL;// 统计呼叫
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_MONITORING_CALL;// 监控呼叫
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_MONITORING_ONLINE;// 监控在线
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_STATISTICS_ORDER;// 统计工单
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_STATISTICS_ROBOT;// 统计机器人
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_SETTING_STATUS;// 设置个人状态
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_SETTING_PLAIN;// 设置会话顺序
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_ORDER_EDIT;// 工单编辑的权限
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_ORDER_DELETE;// 工单删除的权限
extern NSString * _Nullable const SOBOT_ORDER_MODULE_KEY_ORDER_REPLYDELETE;// 工单详情页面删除回复的权限

typedef NSString *SobotOrderModuleType NS_STRING_ENUM;

static SobotOrderModuleType _Nullable const SobotOrderModuleType1222  = @"1222";// 可删除工单
static SobotOrderModuleType _Nullable const SobotOrderModuleType1223  = @"1223";// 可删除工单回复
static SobotOrderModuleType _Nullable const SobotOrderModuleType1224  = @"1224";// 可关闭工单
static SobotOrderModuleType _Nullable const SobotOrderModuleType1225  = @"1225";// 可激活工单
static SobotOrderModuleType _Nullable const SobotOrderModuleTypeOrderSearchAll  = @"1227";// 全局搜索
static SobotOrderModuleType _Nullable const SobotOrderModuleTypeOrder1230  = @"1230";  // 工单历史记录
static SobotOrderModuleType _Nullable const SobotOrderModuleType1611  = @"1611";  // 客户中心
static SobotOrderModuleType _Nullable const SobotOrderModuleTypeOrder1231  = @"1231";  // 工单状态，可见与不可见


NS_ASSUME_NONNULL_BEGIN

@interface SobotOrderLoginUser : SobotBaseEntity
...
// key : SOBOT_ORDER_MODULE_KEY_
-(BOOL)checkModule:(NSString *) key;

-(BOOL)checkModuleByModuleType:(SobotOrderModuleType )key;
